      ...
      <div className="container mx-auto px-4 py-12">
              ...
              <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="md:w-1/2 text-center md:text-left">
                  ...
                  <p className="text-gray-800 text-lg mb-4">
                    KrishiSahayi was founded with a simple yet powerful mission:
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="glass p-8 rounded-2xl text-center shadow-md">
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="glass p-8 rounded-2xl shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-green-600">For Consumers</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Access to fresher, more nutritious produce</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Knowledge about where your food comes from and how it's grown</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Support for local economy and sustainable farming practices</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Reduced environmental impact from shorter supply chains</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Direct communication with farmers</span></li>
              </ul>
            </div>
            <div className="glass p-8 rounded-2xl shadow-md">
              <h3 className="text-xl font-semibold mb-4 text-green-600">For Farmers</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Higher profit margins by selling directly to consumers</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Stable local market for products</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Reduced waste through better demand planning</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Opportunity to showcase sustainable farming practices</span></li>
                <li className="flex items-start"><FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" /><span>Direct feedback from customers</span></li>
              </ul>
            </div>
          </div>
        </section>

        {/* ── TEAM ── fixed: 3 members centered properly ── */}
        <section className="mb-32">
          <h2 className="text-4xl font-bold text-center mb-4 text-gray-900">
            Meet Our Team
          </h2>
          <p className="text-center text-gray-600 text-xl mb-16">
            Passionate people behind KrishiSahayi
          </p>

          {/* 3 members → max-w-3xl centers the row nicely */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
            {teamMembers.map((member) => (
              <div
                key={member.id}
                className="glass p-6 rounded-[30px] flex flex-col items-center shadow-xl hover:shadow-2xl transition-all duration-300 group border border-white/20"
              >
                ...
                <h3 className="text-base font-semibold mb-3 text-gray-900 text-center">
                  {member.name}
                </h3>
                <a
        ...
        <section className="text-center mb-8">
          ...
          <p className="text-xl text-gray-500 max-w-3xl mx-auto mb-8">
            ...
            consumer seeking fresh, local produce, KrishiSahayi is for you.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/register" className="btn btn-primary px-8 py-3 text-lg font-bold shadow-md">
              Sign Up Now
            </Link>
            <Link to="/products" className="btn btn-outline px-8 py-3 text-lg font-bold">
              Browse Products
            </Link>
          </div>
        </section>
